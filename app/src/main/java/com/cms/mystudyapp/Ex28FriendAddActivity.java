...
public class Ex28FriendAddActivity extends AppCompatActivity {
    Switch swSex;
    TextView tvSex;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new MySQLiteOpenHelperFriends2(
                Ex28FriendAddActivity.this, // 현재 화면의 context
                "members.db", // 파일명
                null, // 커서 팩토리
                1); // 버전 번호
        ...
        btnAdd.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view)
            {
                ...
                if(name.equals("")){
                    Toast.makeText(Ex28FriendAddActivity.this,"이름을 입력하시오.",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(hp.equals("")){
                    Toast.makeText(Ex28FriendAddActivity.this,"연락처를 입력하시오.",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(addr.equals("")){
                    Toast.makeText(Ex28FriendAddActivity.this,"주소를 입력하시오.",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(etAge.getText().toString().equals("")){
                    Toast.makeText(Ex28FriendAddActivity.this,"나이를 입력하시오.",Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(Ex28FriendAddActivity.this,"친구가 추가됨!",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void insert(String name, String hp, String sex, String addr, String age) {
        ...
        values.put("age", age);
        db.insert("members", null, values); // 테이블/널컬럼핵/데이터(널컬럼핵=디폴트)
        ...
        Ex28RecyclerViewFriends.selectFriendsList();
    }
}